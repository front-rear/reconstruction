...
class BatchPoseData:
    ...
    def __init__(self, rgbAs=None, rgbBs=None, depthAs=None, depthBs=None, normalAs=None, normalBs=None, maskAs=None, maskBs=None, poseA=None, poseB=None, xyz_mapAs=None, xyz_mapBs=None, tf_to_crops=None, Ks=None, crop_masks=None, model_pts=None, mesh_diameters=None, labels=None,maskAs_orig=None, maskBs_orig=None, depthAs_orig=None, depthBs_orig=None):
        self.rgbAs = rgbAs
        self.rgbBs = rgbBs
        self.maskAs_orig = maskAs_orig
        self.maskBs_orig = maskBs_orig
        self.depthAs = depthAs
        self.depthBs = depthBs
        self.depthAs_orig = depthAs_orig
        self.depthBs_orig = depthBs_orig
